 ...
 public:
  ...
  void Backward(const OpContext &ctx, const TBlob &out_grad,
    ...
    if (param_.kernel.ndim() == 2) {
      ...
      CUDNN_CALL(hipdnnPoolingBackward(s->dnn_handle_,
                                      pooling_desc_,
                                      &alpha,
                                      out_desc_,
                                      m_out_data.dptr_,
  ...
  inline void Init(mshadow::Stream<gpu> *s, const TBlob &in_data,
    ...
    if (param_.kernel.ndim() == 2) {
      ...
      CUDNN_CALL(hipdnnSetTensor4dDescriptor(out_desc_,
                                            ...
                                            out.shape_[3]));
      #if CUDNN_MAJOR >= 5
      CUDNN_CALL(hipdnnSetPooling2dDescriptor(pooling_desc_,
                                             mode_,
                                             nan_prop_,
      ...
      CUDNN_CALL(hipdnnSetTensorNdDescriptor(out_desc_,
                                            ...
                                            &ostride[0]));
      #if CUDNN_MAJOR >= 5
      CUDNN_CALL(hipdnnSetPoolingNdDescriptor(pooling_desc_,
                                             mode_,
                                             nan_prop_,
